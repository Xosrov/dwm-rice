...
static const char *const autostart[] = {
    "/home/stephen/.screenlayout/monitor.sh", NULL,  /* monitor layout & resolution */
    "/home/stephen/.local/bin/dwm-catppuccin.sh", NULL,  /* colourscheme (catppuccin) */ 
    "xset", "r", "rate", "200", "40", NULL,  /* Keyboard repeat rate */
    "picom", NULL,  /* Setting a compositor */
    "dunst", NULL,  /* Setting a notification daemon */
    "xhost", "+si:localuser:stephen", NULL,  /* This should make it so clicking Discord links works */
    "dwmblocks", NULL,  /* dwmblocks (status) */
    "/home/stephen/.local/bin/dotool-stuff.sh", NULL,  /* XRDB john */
